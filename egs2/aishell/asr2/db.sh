...
TIMIT=/data/megastore/Projects/DuJing/data/TIMIT
TSUKUYOMI=downloads
VOXFORGE=downloads
AMI=
...
RUSLAN=downloads
SIWIS=downloads
GIGASPEECH=/data/megastore/Datasets/GigaSpeech/GigaSpeech
...
JDCINAL=downloads
GRABO=downloads
WENETSPEECH=/data/megastore/Datasets/WenetSpeech/WenetSpeech
SPEECHCOMMANDS=downloads
TOTONAC=downloads
PRIMEWORDS_CHINESE=downloads
SEAME=/data/megastore/Projects/DuJing/data/SEAME
BENGALI=downloads
IWSLT14=
BURMESE=downloads
MALAYALAM=downloads
